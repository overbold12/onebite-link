  ...
  return (
    ...
    >
      ...
      >
        ...
        <p id="delete-folder-description" className="mt-2 text-[14px] leading-6 text-[var(--text-sub)]">
          <strong className="font-bold text-[var(--text)]">{folder.name}</strong> 폴더가 사이드바에서
          삭제돼요. 정말 삭제할까요?
        </p>
